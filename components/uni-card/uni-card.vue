<template>
	<view class="uni-card" @click="onClick">
		...
		<view class="uni-card__content" :class="isFull === false || isFull === 'false' ? 'uni-card__content--pd' : ''">
			<view class="row">
				<view class="rowItem"><text class="txtLabel">提交人：</text><text class="txtval">{{itemInfo.SUBMITER}}</text></view>
				<view class="rowItem"><text class="txtLabel">提交时间：</text><text class="txtval">{{itemInfo.SUBMITTIME}}</text></view>
			</view>
			<view class="row">
				<view class="rowItem"><text class="txtLabel">事项类型：</text><text class="txtval">{{itemInfo.FLOWNAME}}</text></view>
				<view class="rowItem"><text class="txtLabel">备注：</text><text class="txtval">{{itemInfo.SUBMITER}}</text></view>
			</view>
		</view>
